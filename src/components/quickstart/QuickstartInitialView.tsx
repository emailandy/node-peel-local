        ...
        <div className="flex-1 flex flex-col">
          <div className="mb-4">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-3xl font-bold bg-gradient-to-r from-yellow-400 to-yellow-200 bg-clip-text text-transparent">
                Peel
              </h2>
            </div>
          </div>
          ...
          <p className="text-neutral-400 mb-8 max-w-sm">
            Drag, drop, and connect AI models to create powerful workflows.
          </p>
